...
exports.generate_request_payload_for_setting_dispo_config_for_item_categories = function (thirdTierApproverGroup) {
   let groupId = thirdTierApproverGroup.id
    ...
    let body = [
        {"categoryName":"Alcohol","approvalUsers":[],"approvalUserGroups":[],"overrideDispositionAuthorizationUsers":[],"overrideDispositionAuthorizationUserGroups":[],"maxHoldDays":11,"maxIndefiniteRetentionDays":1111,"categoryId":31,"isSecondaryApprovalRequired":false,"isTertiaryApprovalRequired":false,"isAutoHold":false,"isApprovalforItemReleaseBlocked":false,"overrideDispositionAuthorization":false,"maxHoldDaysApplytoAll":false,"maxIndefiniteRetentionDaysApplyToAll":false,"usersAndGroups":{"items":[]},"overrideDispositionUsersAndGroups":{"items":[]}},
        {"categoryName":"Cellular Phone","approvalUsers":[],"approvalUserGroups":[],"overrideDispositionAuthorizationUsers":[],"overrideDispositionAuthorizationUserGroups":[],"maxHoldDays":365,"maxIndefiniteRetentionDays":365,"categoryId":28,"isSecondaryApprovalRequired":true,"isTertiaryApprovalRequired":false,"isAutoHold":false,"isApprovalforItemReleaseBlocked":false,"overrideDispositionAuthorization":false,"maxHoldDaysApplytoAll":false,"maxIndefiniteRetentionDaysApplyToAll":false,"usersAndGroups":{"items":[]},"overrideDispositionUsersAndGroups":{"items":[]}},
        {"categoryName":"Currency","approvalUsers":[],"approvalUserGroups":[{"id":groupId}],"overrideDispositionAuthorizationUsers":[],"overrideDispositionAuthorizationUserGroups":[],"maxHoldDays":365,"maxIndefiniteRetentionDays":100,"categoryId":7,"isSecondaryApprovalRequired":true,"isTertiaryApprovalRequired":true,"isAutoHold":false,"isApprovalforItemReleaseBlocked":false,"overrideDispositionAuthorization":false,"maxHoldDaysApplytoAll":false,"maxIndefiniteRetentionDaysApplyToAll":false,"usersAndGroups":{"items":[{"id":groupId,"text":"Cypress Admin Group","type":"group","typeName":"User Groups","icon":"fa fa-users"}]},"overrideDispositionUsersAndGroups":{"items":[]},"areThirdTierUsersEditing":true},
        {"categoryName":"Drugs","approvalUsers":[],"approvalUserGroups":[{"id":groupId}],"overrideDispositionAuthorizationUsers":[],"overrideDispositionAuthorizationUserGroups":[],"maxHoldDays":366,"maxIndefiniteRetentionDays":100,"categoryId":9,"isSecondaryApprovalRequired":true,"isTertiaryApprovalRequired":true,"isAutoHold":false,"isApprovalforItemReleaseBlocked":false,"overrideDispositionAuthorization":false,"maxHoldDaysApplytoAll":false,"maxIndefiniteRetentionDaysApplyToAll":false,"usersAndGroups":{"items":[{"id":groupId,"text":"Cypress Admin Group","type":"group","typeName":"User Groups","icon":"fa fa-users"}]},"overrideDispositionUsersAndGroups":{"items":[]},"areThirdTierUsersEditing":true},
        {"categoryName":"Forensic","approvalUsers":[],"approvalUserGroups":[{"id":groupId}],"overrideDispositionAuthorizationUsers":[],"overrideDispositionAuthorizationUserGroups":[],"maxHoldDays":365,"maxIndefiniteRetentionDays":365,"categoryId":258,"isSecondaryApprovalRequired":true,"isTertiaryApprovalRequired":true,"isAutoHold":false,"isApprovalforItemReleaseBlocked":false,"overrideDispositionAuthorization":false,"maxHoldDaysApplytoAll":false,"maxIndefiniteRetentionDaysApplyToAll":false,"usersAndGroups":{"items":[{"id":groupId,"text":"Cypress Admin Group","type":"group","typeName":"User Groups","icon":"fa fa-users"}]},"overrideDispositionUsersAndGroups":{"items":[]},"areThirdTierUsersEditing":true}]
